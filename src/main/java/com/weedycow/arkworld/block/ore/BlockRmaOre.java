...
public class BlockRmaOre extends Block
{
    public BlockRmaOre()
    {
        ...
        this.setRegistryName("rma_ore");
        this.setSoundType(SoundType.STONE);
        this.setHarvestLevel("pickaxe", 2);
        this.setCreativeTab(ArkCreateTab.BLOCK);
        this.setUnlocalizedName(Arkworld.MODID + ".rmaOre");
    }
    ...
    {
        return new ItemStack(ItemRegistry.RMA_ORE);
    }
}
