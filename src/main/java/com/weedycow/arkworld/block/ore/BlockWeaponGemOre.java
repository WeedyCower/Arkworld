...
public class BlockWeaponGemOre extends Block
{
    public BlockWeaponGemOre()
    {
        super(Material.ROCK, MapColor.STONE);
        this.setHardness(3f);
        this.setResistance(5f);
        this.setRegistryName("weapon_gem_ore");
        this.setSoundType(SoundType.STONE);
        this.setHarvestLevel("pickaxe", 2);
        this.setCreativeTab(ArkCreateTab.BLOCK);
        this.setUnlocalizedName(Arkworld.MODID + ".weaponGemOre");
    }
    ...
    {
        return ItemRegistry.WEAPON_GEM;
    }
    ...
    {
        return new ItemStack(ItemRegistry.WEAPON_GEM_ORE);
    }
}
