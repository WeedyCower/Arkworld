...
public class BlockOricoalOre extends Block
{
    public BlockOricoalOre()
    {
        super(Material.ROCK, MapColor.STONE);
        this.setHardness(3f);
        this.setResistance(5f);
        this.setRegistryName("oricoal_ore");
        this.setSoundType(SoundType.STONE);
        this.setHarvestLevel("pickaxe", 0);
        this.setCreativeTab(ArkCreateTab.BLOCK);
        this.setUnlocalizedName(Arkworld.MODID + ".oricoalOre");
    }
    ...
    {
        return new ItemStack(ItemRegistry.ORICOAL_ORE);
    }
}
