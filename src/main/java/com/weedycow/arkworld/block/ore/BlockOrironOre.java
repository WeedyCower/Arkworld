...
public class BlockOrironOre extends Block
{
    public BlockOrironOre()
    {
        super(Material.ROCK, MapColor.STONE);
        this.setHardness(3f);
        this.setResistance(5f);
        this.setRegistryName("oriron_ore");
        this.setSoundType(SoundType.STONE);
        this.setHarvestLevel("pickaxe", 1);
        this.setCreativeTab(ArkCreateTab.BLOCK);
        this.setUnlocalizedName(Arkworld.MODID + ".orironOre");
    }
    ...
    {
        return ItemRegistry.ORIRON_ORE;
    }
    ...
    {
        return new ItemStack(ItemRegistry.ORIRON_ORE);
    }
}
