...
public class BlockOrimanganeseOre extends Block
{
    public BlockOrimanganeseOre()
    {
        super(Material.ROCK, MapColor.STONE);
        this.setHardness(3f);
        this.setResistance(5f);
        this.setRegistryName("orimanganese_ore");
        this.setSoundType(SoundType.STONE);
        this.setHarvestLevel("pickaxe", 1);
        this.setCreativeTab(ArkCreateTab.BLOCK);
        this.setUnlocalizedName(Arkworld.MODID + ".orimanganeseOre");
    }
    ...
    {
        return ItemRegistry.ORIMANGANESE_ORE;
    }
    ...
    {
        return new ItemStack(ItemRegistry.ORIMANGANESE_ORE);
    }
}
