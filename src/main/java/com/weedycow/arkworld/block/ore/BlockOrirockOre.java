...
public class BlockOrirockOre extends Block
{
    public BlockOrirockOre()
    {
        super(Material.ROCK, MapColor.STONE);
        this.setHardness(3f);
        this.setResistance(5f);
        this.setRegistryName("orirock_ore");
        this.setSoundType(SoundType.STONE);
        this.setHarvestLevel("pickaxe", 0);
        this.setCreativeTab(ArkCreateTab.BLOCK);
        this.setUnlocalizedName(Arkworld.MODID + ".orirockOre");
    }
    ...
    {
        return new ItemStack(ItemRegistry.ORIROCK_ORE);
    }
}
