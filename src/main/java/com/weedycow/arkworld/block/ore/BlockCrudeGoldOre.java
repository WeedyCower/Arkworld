...
public class BlockCrudeGoldOre extends Block
{
    public BlockCrudeGoldOre()
    {
        super(Material.ROCK, MapColor.STONE);
        this.setHardness(3f);
        this.setResistance(5f);
        this.setRegistryName("crude_gold_ore");
        this.setSoundType(SoundType.STONE);
        this.setHarvestLevel("pickaxe", 1);
        this.setCreativeTab(ArkCreateTab.BLOCK);
        this.setUnlocalizedName(Arkworld.MODID + ".crudeGoldOre");
    }
    ...
    {
        return ItemRegistry.CRUDE_GOLD_ORE;
    }
    ...
    public int quantityDroppedWithBonus(int fortune, @Nonnull Random random)
    {
        if (fortune > 0)
        {
            int bonusFactor = Math.max(random.nextInt(fortune + 2), 0);
    ...
    {
        return new ItemStack(ItemRegistry.CRUDE_GOLD_ORE);
    }
}
