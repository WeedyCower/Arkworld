...
public class BlockMixedGoldOre extends Block
{
    public BlockMixedGoldOre()
    {
        super(Material.ROCK, MapColor.STONE);
        this.setHardness(3f);
        this.setResistance(5f);
        this.setRegistryName("mixed_gold_ore");
        this.setSoundType(SoundType.STONE);
        this.setHarvestLevel("pickaxe", 1);
        this.setCreativeTab(ArkCreateTab.BLOCK);
        this.setUnlocalizedName(Arkworld.MODID + ".mixedGoldOre");
    }
    ...
    {
        return ItemRegistry.MIXED_GOLD_ORE;
    }
    ...
    {
        return new ItemStack(ItemRegistry.MIXED_GOLD_ORE);
    }
}
