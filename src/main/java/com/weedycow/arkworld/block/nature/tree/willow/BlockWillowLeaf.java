...
public class BlockWillowLeaf extends BlockLeaves
{
    public BlockWillowLeaf()
    {
        super();
        this.setUnlocalizedName(Arkworld.MODID + ".willowLeaf");
        this.setCreativeTab(ArkCreateTab.BLOCK);
        this.setRegistryName("willow_leaf");
    ...
    {
        return ItemRegistry.WILLOW_LEAF;
    }
