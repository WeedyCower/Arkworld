...
public class BlockNiceMushroom extends BlockBush implements IGrowable
{
    public BlockNiceMushroom()
    {
        super(Material.PLANTS);
        this.setUnlocalizedName(Arkworld.MODID + ".niceMushroom");
        this.setCreativeTab(ArkCreateTab.BLOCK);
        this.setRegistryName("nice_mushroom");
