...
public class BlockFungusBlanket extends BlockBush implements IGrowable
{
    public BlockFungusBlanket()
    {
        super(Material.PLANTS);
        this.setUnlocalizedName(Arkworld.MODID + ".fungusBlanket");
        this.setCreativeTab(ArkCreateTab.BLOCK);
        this.setRegistryName("fungus_blanket");
