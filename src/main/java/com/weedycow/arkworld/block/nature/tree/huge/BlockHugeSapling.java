...
public class BlockHugeSapling extends BlockBush implements IGrowable
{
    public static final PropertyInteger STAGE = PropertyInteger.create("stage", 0, 1);
    protected static final AxisAlignedBB SAPLING_AABB = new AxisAlignedBB(0.09999999403953552D, 0.0D, 0.09999999403953552D, 0.8999999761581421D, 0.800000011920929D, 0.8999999761581421D);

    public BlockHugeSapling()
    {
        super();
        this.setUnlocalizedName(Arkworld.MODID + ".hugeSapling");
        this.setCreativeTab(ArkCreateTab.BLOCK);
        this.setRegistryName("huge_sapling");
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        WorldGenerator worldgenerator = new WorldGenHugeTree(true,10,20,BlockRegistry.HUGE_LOG.getDefaultState(),BlockRegistry.HUGE_LEAF.getDefaultState());
