...
public class BlockOriginiumFloor extends BlockFloor
{
    public BlockOriginiumFloor()
    {
        super(Type.ORIGINIUM_FLOOR);
    }
    ...
    {
        return new TileOriginiumFloor();
    }

    public static class TileOriginiumFloor extends ArkTileTickable
    {
        public TileOriginiumFloor()
        {
            super(Type.ORIGINIUM_FLOOR.getName(),20,false);
        }
        ...
        protected void intervalExecute()
        {
            for(Entity entity : ArkBlockUtil.getEntityOnBlockUp(world,pos))
            {
                if(entity instanceof EntityLivingBase)
                {
                    ...
                    state.addFunctionOnlyTick(EnumState.ORIGINIUM_STIMULATION,1200);
                }
            }
        }
