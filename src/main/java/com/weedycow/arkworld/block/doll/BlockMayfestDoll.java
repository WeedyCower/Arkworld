...
public class BlockMayfestDoll extends BlockDoll
{
    public BlockMayfestDoll()
    {
        super("mayfest_doll","mayfestDoll");
    }
    ...
    {
        return new TileMayfestDoll();
    }

    public static class TileMayfestDoll extends ArkTile
    {
        AnimationController<TileMayfestDoll> controllerAttack = new AnimationController<>(this, "attack", 1, this::PlayState);
        AnimationController<TileMayfestDoll> controllerIdle = new AnimationController<>(this, "idle", 1, this::PlayState);

        public TileMayfestDoll()
        {
            super(Mayfest.ID);
        }
        ...
        private <E extends TileEntity & IAnimatable> PlayState PlayState(AnimationEvent<E> event)
        {
            ...
            else controllerIdle.setAnimation(new AnimationBuilder().addAnimation("animation.mayfest.idle", true));
