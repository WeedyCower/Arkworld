...
{
    private static final IBlockState TRUNK = BlockRegistry.WILLOW_LOG.getDefaultState();
    private static final IBlockState LEAF = BlockRegistry.WILLOW_LEAF.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.FALSE);
    ...
    protected boolean canGrowInto(Block blockType)
    {
        ...
        return material == Material.AIR || material == Material.LEAVES || blockType == BlockRegistry.GRASS_WITHERED || blockType == BlockRegistry.DERELICT_DIRT || blockType == Blocks.LOG || blockType == Blocks.LOG2 || blockType == Blocks.SAPLING || blockType == Blocks.VINE || blockType == BlockRegistry.WILLOW_SAPLING || blockType == BlockRegistry.WILLOW_LOG;
    }
    ...
    public boolean generate(@Nonnull World worldIn, Random rand, BlockPos position)
    {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = state.getBlock().canSustainPlant(state, worldIn, down, net.minecraft.util.EnumFacing.UP, BlockRegistry.WILLOW_SAPLING);
