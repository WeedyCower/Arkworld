...
public class HighWeaponMod extends NormalItem
{
    public HighWeaponMod()
    {
        super("high_weapon_mod", ArkCreateTab.ITEM,1);
    }
    ...
    public void addInformation(@Nonnull ItemStack stack, @Nullable World worldIn, @Nonnull List<String> tooltip, @Nonnull ITooltipFlag flagIn)
    {
        ...
        tooltip.add(I18n.format("item.arkworld.info.weaponMod")+(2-weapon.getRank()));
    ...
    public ActionResult<ItemStack> onItemRightClick(@Nonnull World worldIn, EntityPlayer playerIn, @Nonnull EnumHand handIn)
    {
        ...
        if(process.getRank()<2 && !worldIn.isRemote)
        {
            process.clear();
