...
public class CannedVegetables extends ItemFood
{
    public CannedVegetables()
    {
        ...
        this.setUnlocalizedName(Arkworld.MODID + ".cannedVegetables");
        this.setRegistryName("canned_vegetables");
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        tooltip.add(I18n.format("item.arkworld.info.food_addStamina")+10);
    }
