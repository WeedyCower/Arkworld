...
public class ArmyProvisions extends ItemFood
{
    public ArmyProvisions()
    {
        super(10, 5, false);
        this.setAlwaysEdible();
        this.setCreativeTab(ArkCreateTab.FOOD);
        this.setUnlocalizedName(Arkworld.MODID + ".armyProvisions");
        this.setRegistryName("army_provisions");
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        tooltip.add(I18n.format("item.arkworld.info.food_addStamina")+20);
    }
