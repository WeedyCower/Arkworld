...
public class VictoriaCake extends ItemFood
{
    public VictoriaCake()
    {
        super(8, 4, true);
        ...
        this.setUnlocalizedName(Arkworld.MODID + ".victoriaCake");
        this.setRegistryName("victoria_cake");
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        tooltip.add(I18n.format("item.arkworld.info.food_addStamina")+16);
