...
public class Biscuit extends ItemFood
{
    public Biscuit()
    {
        ...
        this.setUnlocalizedName(Arkworld.MODID + ".biscuit");
        this.setRegistryName("biscuit");
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        tooltip.add(I18n.format("item.arkworld.info.food_addStamina")+8);
    }
