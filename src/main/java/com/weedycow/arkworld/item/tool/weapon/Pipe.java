...
public class Pipe extends MeleeWeapon
{
    public Pipe()
    {
        super(Rioter.ID, EnumWeaponRank.LOW);
        this.setUnlocalizedName(Arkworld.MODID + ".pipe");
    ...
    public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected)
    {
        ...
        if(entityIn instanceof EntityPlayer && !entityIn.world.isRemote)
        {
            ...
            onDamage(weapon,melee.pipe.initAttackDamage,1);

            onDurability(weapon,melee.pipe.durability);
    ...
    public boolean onEntitySwing(EntityLivingBase entityLiving, ItemStack stack)
    {
        if(entityLiving instanceof EntityPlayer)
        {
            ...
            {
                controllerAttack.setAnimation(new AnimationBuilder().addAnimation("animation.pipe.attack", false));
    ...
    AnimationController<Pipe> controllerAttack = new AnimationController<>(this, "attack", 1, this::predicate);
}
