...
public class GuerrillaShield extends ShieldWeapon
{
    float tantRange;

    public GuerrillaShield()
    {
        super(GuerrillaShieldGuard.ID, EnumWeaponRank.HIGH);
        this.setUnlocalizedName(Arkworld.MODID + ".guerrillaShield");
        this.setRegistryName("guerrilla_shield");
    }
    ...
    public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected)
    {
        ...
        if(entityIn instanceof EntityPlayer && ItemStack.areItemStacksEqual(((EntityPlayer) entityIn).getActiveItemStack(),stack))
        {
            ...
            {
                if(entityLivingBase instanceof EntityPlayer && entityLivingBase != entityIn && shield.guerrillaShield.canTauntPlayer)
                {
                ...
                else if (entityLivingBase instanceof EntityLiving && shield.guerrillaShield.canTauntEntityLiving)
                {
        ...
        onStamina(weapon,shield.guerrillaShield.stamina);

        onDurability(weapon,shield.guerrillaShield.durability);
    }
}
