...
public class FaustSpecialArrow extends ItemArrow
{
    public FaustSpecialArrow()
    {
        super(com.weedycow.arkworld.entity.weapon.Arrow.Type.FAUST_SPECIAL_ARROW, ArkConfig.item.weapon.ammo.arrow.faustSpecialArrow.attackDamage);
        this.setUnlocalizedName(Arkworld.MODID + ".faustSpecialArrow");
        this.setRegistryName("faust_special_arrow");
