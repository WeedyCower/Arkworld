...
public class HeavyShield extends ShieldWeapon
{
    public HeavyShield()
    {
        super(HeavyDefender.ID, EnumWeaponRank.HIGH);
        this.setUnlocalizedName(Arkworld.MODID + ".heavyShield");
        this.setRegistryName("heavy_shield");
    }
    ...
    public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected)
    {
        ...
        if(entityIn instanceof EntityLivingBase && !entityIn.world.isRemote)
        {
            ...
            onStamina(weapon,shield.heavyShield.stamina);

            onDurability(weapon,shield.heavyShield.durability);
        }
    }
}
