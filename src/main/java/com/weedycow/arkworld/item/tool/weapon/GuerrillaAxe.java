...
public class GuerrillaAxe extends MeleeWeapon
{
    public GuerrillaAxe()
    {
        super(GuerrillaSiegebreaker.ID,EnumWeaponRank.NORMAL);
        this.setUnlocalizedName(Arkworld.MODID + ".guerrillaAxe");
        this.setRegistryName("guerrilla_axe");
    }
    ...
    public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected)
    {
        ...
        if(entityIn instanceof EntityPlayer && !entityIn.world.isRemote)
        {
            ...
            onStamina(weapon,melee.guerrillaAxe.stamina);

            onDamage(weapon,melee.guerrillaAxe.initAttackDamage,melee.guerrillaAxe.surplusAttackDamage);

            onDurability(weapon,melee.guerrillaAxe.durability);
    ...
    public boolean onEntitySwing(EntityLivingBase entityLiving, ItemStack stack)
    {
        if(entityLiving instanceof EntityPlayer)
        {
            ...
            {
                controllerAttack.setAnimation(new AnimationBuilder().addAnimation("animation.guerrilla_axe.attack", false));
    ...
    AnimationController<GuerrillaAxe> controllerAttack = new AnimationController<>(this, "attack", 1, this::predicate);
}
